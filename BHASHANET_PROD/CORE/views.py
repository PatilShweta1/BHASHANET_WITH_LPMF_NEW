...
def termsandconditions(request):
    ...
    print(obj_data)
    return render(request, 'core/termsandconditions.html', {'obj_data': obj_data})
...
def IDNCCTLD(request):
    ...
    return render(request, 'core/IDN_CCTLD.html', {'obj_data': obj_data, 'obj_data_2': obj_data_2})
...
def bestpractices(request):
    ...
    return render(request, 'core/best_practices.html', {'obj_data': obj_data})
...
def EAI(request):
    ...
    return render(request, 'core/EAI.html', {'obj_data': obj_data})
...
def UA(request):
    ...
    return render(request, 'core/UA.html', {'obj_data': obj_data, 'list_data': list_data})
...
def tools(request):
    ...
    return render(request, 'core/tools.html', {'tool_detail': tool_detail})
    ...
    if request.method == "POST":
        if 'punycode_convert' in request.POST:
            ...
            try:
                ...
                return render(request, 'core/unicode_punnycode_generator.html',
...
def transliteration(request):
    return render(request, 'core/transliteration.html')


# -------------  STARTS-----------------------

def unicode_fonts(request):
    return render(request, 'core/unicode_fonts.html')


# -------------  STARTS-----------------------

def script_detection(request):
    return render(request, 'core/script_detection.html')


# -------------  STARTS-----------------------

def language_detection(request):
    return render(request, 'core/language_detection.html')


# -------------  STARTS-----------------------

def cdac_keyboard(request):
    return render(request, 'core/cdac_keyboard.html')
    ...
    if request.method == "POST":
        ...
        if email_form_obj.is_valid():
            try:
                ...
                return render(request, 'core/email_validator.html',{'email_form_obj':email_form_obj})
    ...
    try:
        if request.method == "POST":
            ...
            if domain_form_obj.is_valid():
                ...
                #domain_name = domain_form_obj.data['Domain_Name']
                #return render(request, 'core/domain_validator.html',{'domain_form_obj': domain_form_obj})
...
def becomeuaready(request):
    ...
    return render(request, 'core/becomeuaready.html', {'obj_data': obj_data, 'list_data': list_data})
...
def testimonial(request):
    ...
    return render(request, "core/testimonials.html", {'obj_testimonialsMessages':obj_testimonialsMessages})
...
def gallery(request):
    ...
    return render(request, 'core/gallery.html', {'gallery_videos': gallery_videos, 'gallery_video_headings': gallery_video_headings})
# -------------  STARTS-----------------------
...
def SOPTechnalogyPage(request):
    ...
    return render(request, 'core/sop_tech_document.html', context)
...
def dashboard(request):
    ...
    # file_path = '/var/www/html/BHASHANET_PROD_CODE/BHASHANET_PROD/CORE/registry.txt'
        ...
        if request.method == 'POST':
            ...
            if Blog_form_obj.is_valid():
                ...
                if temp_obj.Blog_Author == user_obj:
                    ...
                    Blog_form_obj = Blog_form(request.POST,request.FILES,instance=Blog_obj)
                    return render(request, 'core/add_blog.html', {'Blog_form_obj': Blog_form_obj,'flag_blog':'Edit'})
            else:
                Blog_form_obj = Blog_form(request.POST,request.FILES,instance=Blog_obj)
                return render(request, 'core/add_blog.html', {'Blog_form_obj': Blog_form_obj,'flag_blog':'Edit'})
        else:
...
def delete_blog(request,id):
    if request.user.is_authenticated:
        ...
        return render(request, 'core/admin_blog_datatable.html',context)
    else:
        return redirect('blogs')
...
def idn_websites_request_AJAX(request):
    ...
    return render(request, 'core/idn_websites_request_AJAX.html', {'categories': categories, 'captcha_value' : captcha_value, 'captcha_hidden': captcha_hidden})
...
def test_support(request):
    ...
    return render(request, 'core/support_new.html')
...
def display_table2(request):
    with open('updated_file.json') as f:
        Tabledata = json.load(f) 
    return render(request, 'core/Admin_Dashboard.html', {'Tabledata': Tabledata})
