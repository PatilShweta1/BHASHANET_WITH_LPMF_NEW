...
class Article(models.Model):
    ...
    Article_Title_icon=models.ImageField(upload_to='core/Article/icon/', blank=True, null=True,
                                            validators=[validate_image,
                                                        FileExtensionValidator(
                                                            allowed_extensions=["jpg", "png",
                                                                                "JPEG", "svg"])],
                                            help_text='Maximum file size allowed is 5Mb')
    Article_Title_Image1=models.ImageField(upload_to='core/Article/icon/', blank=True, null=True,
                                            validators=[validate_image,
                                                        FileExtensionValidator(
                                                            allowed_extensions=["jpg", "png",
                                                                                "JPEG", "svg"])],
                                            help_text='Maximum file size allowed is 5Mb')
    Article_Title_Image2=models.ImageField(upload_to='core/Article/icon/', blank=True, null=True,
                                            validators=[validate_image,
                                                        FileExtensionValidator(
                                                            allowed_extensions=["jpg", "png",
                                                                                "JPEG", "svg"])],
                                            help_text='Maximum file size allowed is 5Mb')
    Article_Upload_Doc1=models.FileField(upload_to='core/Article/upload_doc/', blank=True, null=True)
    Article_Upload_Doc2=models.FileField(upload_to='core/Article/upload_doc/', blank=True, null=True)
    Article_Upload_Doc3=models.FileField(upload_to='core/Article/upload_doc/', blank=True, null=True)
    Article_Upload_Doc4=models.FileField(upload_to='core/Article/upload_doc/', blank=True, null=True)
    Article_Upload_Doc5=models.FileField(upload_to='core/Article/upload_doc/', blank=True, null=True)
    ...
    Article_Image1=models.ImageField(upload_to='core/Article/image/', blank=True, validators=[validate_image,
                                                                                                FileExtensionValidator(
                                                                                                    allowed_extensions=[
                                                                                                        "jpg", "png",
                                                                                                        "JPEG",
                                                                                                        "svg"])],
                                        help_text='Maximum file size allowed is 5Mb')
    Article_Image2=models.ImageField(upload_to='core/Article/image/', blank=True, validators=[validate_image,
                                                                                                FileExtensionValidator(
                                                                                                    allowed_extensions=[
                                                                                                        "jpg", "png",
                                                                                                        "JPEG",
                                                                                                        "svg"])],
                                        help_text='Maximum file size allowed is 5Mb')
    Article_Image3=models.ImageField(upload_to='core/Article/image/', blank=True, validators=[validate_image,
                                                                                                FileExtensionValidator(
                                                                                                    allowed_extensions=[
                                                                                                        "jpg", "png",
                                                                                                        "JPEG",
                                                                                                        "svg"])],
                                        help_text='Maximum file size allowed is 5Mb')
    Article_Image4=models.ImageField(upload_to='core/Article/image/', blank=True, validators=[validate_image,
                                                                                                FileExtensionValidator(
                                                                                                    allowed_extensions=[
                                                                                                        "jpg", "png",
                                                                                                        "JPEG",
                                                                                                        "svg"])],
                                        help_text='Maximum file size allowed is 5Mb')
    Article_Image5=models.ImageField(upload_to='core/Article/image/', blank=True, validators=[validate_image,
                                                                                                FileExtensionValidator(
                                                                                                    allowed_extensions=[
                                                                                                        "jpg", "png",
                                                                                                        "JPEG",
    ...
    Article_video=models.FileField(upload_to='core/Article/videos_uploaded/', null=True, blank=True,
...
class TermsAndConditions(models.Model):
    ...
    TermsAndConditions_document1=models.FileField(upload_to='core/terms_and_conditions/documents', null=True,
                                                    blank=True,
                                                    validators=[FileExtensionValidator(
    ...
    TermsAndConditions_document2=models.FileField(upload_to='core/terms_and_conditions/documents', null=True,
                                                    blank=True,
                                                    validators=[FileExtensionValidator(
                                                        allowed_extensions=['doc', 'docx', 'pdf'])])
    ...
    TermsAndConditions_document3=models.FileField(upload_to='core/terms_and_conditions/documents', null=True,
                                                    blank=True,
                                                    validators=[FileExtensionValidator(
                                                        allowed_extensions=['doc', 'docx', 'pdf'])])
    ...
    TermsAndConditions_document4=models.FileField(upload_to='core/terms_and_conditions/documents', null=True,
                                                    blank=True,
                                                    validators=[FileExtensionValidator(
                                                        allowed_extensions=['doc', 'docx', 'pdf'])])
    ...
    TermsAndConditions_document5=models.FileField(upload_to='core/terms_and_conditions/documents', null=True,
                                                    blank=True,
                                                    validators=[FileExtensionValidator(
                                                        allowed_extensions=['doc', 'docx', 'pdf'])])
    TermsAndConditions_image=models.ImageField(upload_to='core/terms_and_conditions/img', blank=True, null=True,
...
#     Story_Image=models.ImageField(upload_to='core/Success_stories/', blank=True, validators=[validate_image,
#                                                                                                      FileExtensionValidator(
#                                                                                                          allowed_extensions=[
#                                                                                                              "jpg",
#                                                                                                              "png",
...
#                                                                                                              "svg"])],
#                                              help_text='Maximum file size allowed is 5Mb'),
#     Story_Link=models.CharField(max_length=500, blank=True, null=True),
...
class BestPractices(models.Model):
    ...
    BestPractices_title_image=models.ImageField(upload_to='core/best_practices/img', blank=True, null=True,
                                                validators=[validate_image, FileExtensionValidator(
                                                    allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                                help_text='Maximum file size allowed is 5Mb')
    ...
    BestPractices_image1=models.ImageField(upload_to='core/best_practices/img', blank=True, null=True,
                                            validators=[validate_image, FileExtensionValidator(
                                                allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                            help_text='Maximum file size allowed is 5Mb')
    ...
    BestPractices_image2=models.ImageField(upload_to='core/best_practices/img', blank=True, null=True,
                                            validators=[validate_image, FileExtensionValidator(
                                                allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                            help_text='Maximum file size allowed is 5Mb')
    ...
    BestPractices_image3=models.ImageField(upload_to='core/best_practices/img', blank=True, null=True,
                                            validators=[validate_image, FileExtensionValidator(
                                                allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                            help_text='Maximum file size allowed is 5Mb')
    ...
    BestPractices_image4=models.ImageField(upload_to='core/best_practices/img', blank=True, null=True,
                                            validators=[validate_image, FileExtensionValidator(
                                                allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                            help_text='Maximum file size allowed is 5Mb')
    ...
    BestPractices_image5=models.ImageField(upload_to='core/best_practices/img', blank=True, null=True,
                                            validators=[validate_image, FileExtensionValidator(
                                                allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                            help_text='Maximum file size allowed is 5Mb')
...
class Announcements(models.Model):
    ...
    Announcement_PublishStatus=models.CharField(
        max_length=20, choices=[("Published", "Published"), ("Unpublished", "Unpublished")], default="Unpublished")
    Announcement_Image=models.ImageField(upload_to='core/Announcement/', blank=True, validators=[validate_image,
                                                                                                    FileExtensionValidator(
                                                                                                        allowed_extensions=[
                                                                                                            "jpg",
                                                                                                            "png",
...
class Testimonials(models.Model):
    ...
    Testimonials_PublishStatus=models.CharField(
        max_length=20, choices=[("Published", "Published"), ("Unpublished", "Unpublished")], default="Unpublished")
    Testimonials_Image=models.ImageField(upload_to='core/Testimonials/', blank=True, validators=[validate_image,
                                                                                                    FileExtensionValidator(
                                                                                                        allowed_extensions=[
                                                                                                            "jpg",
                                                                                                            "png",
...
class Objectives(models.Model):
    ...
    Objectives_Thumbnail=models.ImageField(
        upload_to="core/Objectives/Thumbnail", validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png", "JPEG", "svg"])],
        help_text='Maximum file size allowed is 5Mb',
...
class Document(models.Model):
    ...
    Document_Thumbnail=models.ImageField(
        upload_to="core/Document/Thumbnail", validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png", "JPEG", "svg"])],
        help_text='Maximum file size allowed is 5Mb',
        height_field=None, width_field=None, max_length=None, null=True, blank=True)
    Document_DocumentFile=models.FileField(upload_to="core/Document/DocumentFile",
                                            validators=[
...
class PrivacyPolicy(models.Model):
    ...
    PrivacyPolicy_image=models.ImageField(upload_to='core/privacy_policy/img', blank=True, null=True,
                                            validators=[validate_image, FileExtensionValidator(
                                                allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                            help_text='Maximum file size allowed is 5Mb')
...
class UAIndiaProgramme(models.Model):
    ...
    UAIndiaProgramme_Title_Image=models.ImageField(upload_to='core/UAIndiaProgramme/image/', blank=True, null=True,
                                                    validators=[validate_image,
                                                                FileExtensionValidator(
                                                                    allowed_extensions=["jpg", "png",
                                                                                        "JPEG"])],
    ...
    UAIndiaProgramme_Image1=models.ImageField(upload_to='core/UAIndiaProgramme/image/', blank=True, null=True,
                                                validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png",
                                                                                    "JPEG"])],
    ...
    UAIndiaProgramme_Image2=models.ImageField(upload_to='core/UAIndiaProgramme/image/', blank=True, null=True,
                                                validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png",
                                                                                    "JPEG"])],
    ...
    UAIndiaProgramme_Image3=models.ImageField(upload_to='core/UAIndiaProgramme/image/', blank=True, null=True,
                                                validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png",
                                                                                    "JPEG"])],
    ...
    UAIndiaProgramme_Image4=models.ImageField(upload_to='core/UAIndiaProgramme/image/', blank=True, null=True,
                                                validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png",
                                                                                    "JPEG"])],
    ...
    UAIndiaProgramme_Image5=models.ImageField(upload_to='core/UAIndiaProgramme/image/', blank=True, null=True,
                                                validators=[validate_image,
                                                            FileExtensionValidator(
                                                                allowed_extensions=["jpg", "png",
                                                                                    "JPEG"])],
...
class IDNLanguages(models.Model):
    ...
    IDNLanguages_Policies_Document=models.FileField(upload_to="core/Document/IDNLanguages_Policies_Document",
                                                    validators=[
                                                        FileExtensionValidator(
...
class IDNccTLDs(models.Model):
    ...
    IDNccTLDs_Image1=models.ImageField(upload_to='core/IDNccTLDs/image/', blank=True, null=True,
                                        validators=[validate_image,
                                                    FileExtensionValidator(
                                                        allowed_extensions=["jpg", "png",
                                                                            "JPEG"])],
                                        help_text='Maximum file size allowed is 5Mb')
    IDNccTLDs_Image2=models.ImageField(upload_to='core/IDNccTLDs/image/', blank=True, null=True,
                                        validators=[validate_image,
                                                    FileExtensionValidator(
                                                        allowed_extensions=["jpg", "png",
                                                                            "JPEG"])],
                                        help_text='Maximum file size allowed is 5Mb')
    IDNccTLDs_Image3=models.ImageField(upload_to='core/IDNccTLDs/image/', blank=True, null=True,
                                        validators=[validate_image,
                                                    FileExtensionValidator(
                                                        allowed_extensions=["jpg", "png",
                                                                            "JPEG"])],
                                        help_text='Maximum file size allowed is 5Mb')
    IDNccTLDs_Image4=models.ImageField(upload_to='core/IDNccTLDs/image/', blank=True, null=True,
                                        validators=[validate_image,
                                                    FileExtensionValidator(
                                                        allowed_extensions=["jpg", "png",
                                                                            "JPEG"])],
...
class Tools(models.Model):
    ...
    Tools_ThumbnailImage=models.FileField(
        upload_to='core/tools/thunbnail_img/', blank=True, null=True)
    Tools_Image=models.ImageField(upload_to='core/tools/img', blank=True, null=True,
                                    validators=[validate_image, FileExtensionValidator(
                                        allowed_extensions=["jpg", "png", "JPEG", 'svg'])],
                                    help_text='Maximum file size allowed is 5Mb')
...
class EmailAddressInternationalization(models.Model):
    ...
    EmailAddressInternationalization_title_image=models.ImageField(
        upload_to='core/EmailAddressInternationalization/img', blank=True,
    ...
    EmailAddressInternationalization_image1=models.ImageField(upload_to='core/EmailAddressInternationalization/img',
                                                                blank=True,
                                                                null=True,
                                                                validators=[validate_image, FileExtensionValidator(
    ...
    EmailAddressInternationalization_image2=models.ImageField(upload_to='core/EmailAddressInternationalization/img',
                                                                blank=True,
                                                                null=True,
                                                                validators=[validate_image, FileExtensionValidator(
                                                                    allowed_extensions=["jpg", "png", "JPEG",
    ...
    EmailAddressInternationalization_image3=models.ImageField(upload_to='core/EmailAddressInternationalization/img',
                                                                blank=True,
                                                                null=True,
                                                                validators=[validate_image, FileExtensionValidator(
                                                                    allowed_extensions=["jpg", "png", "JPEG",
    ...
    EmailAddressInternationalization_image4=models.ImageField(upload_to='core/EmailAddressInternationalization/img',
                                                                blank=True,
                                                                null=True,
                                                                validators=[validate_image, FileExtensionValidator(
                                                                    allowed_extensions=["jpg", "png", "JPEG",
    ...
    EmailAddressInternationalization_image5=models.ImageField(upload_to='core/EmailAddressInternationalization/img',
                                                                blank=True,
                                                                null=True,
                                                                validators=[validate_image, FileExtensionValidator(
                                                                    allowed_extensions=["jpg", "png", "JPEG",
...
class UniversalAcceptance(models.Model):
    ...
    UniversalAcceptance_image1=models.FileField(upload_to='core/privacy_policy/img', blank=True, null=True,
                                                validators=[validate_image, FileExtensionValidator(
                                                    allowed_extensions=["jpg", "png", "JPEG", 'svg', 'webp'])],
                                                help_text='Maximum file size allowed is 5Mb')
    UniversalAcceptance_image2=models.FileField(upload_to='core/privacy_policy/img', blank=True, null=True,
                                                validators=[validate_image, FileExtensionValidator(
                                                    allowed_extensions=["jpg", "png", "JPEG", 'svg', 'webp'])],
                                                help_text='Maximum file size allowed is 5Mb')
    UniversalAcceptance_image3=models.FileField(upload_to='core/privacy_policy/img', blank=True, null=True,
                                                validators=[validate_image, FileExtensionValidator(
                                                    allowed_extensions=["jpg", "png", "JPEG", 'svg', 'webp'])],
                                                help_text='Maximum file size allowed is 5Mb')
...
class Stackholder(models.Model):
    ...
    Stackholder_image=models.FileField(upload_to='core/Stackholder/img', blank=True, null=True,
                                        validators=[validate_image, FileExtensionValidator(
                                            allowed_extensions=["jpg", "png", "JPEG", 'svg', 'webp'])],
                                        help_text='Maximum file size allowed is 5Mb')
...
class TestimonialsMessages(models.Model):
    ...
    TestimonialsMessages_PublishStatus=models.CharField(
        max_length=20, choices=[("Published", "Published"), ("Unpublished", "Unpublished")],
        default="Unpublished")
    TestimonialsMessages_Image=models.ImageField(upload_to='core/TestimonialsMessages/', blank=True,
                                                    validators=[validate_image,
                                                                FileExtensionValidator(
                                                                    allowed_extensions=[
                                                                        "jpg",
...
class IDNReadyWebsites(models.Model):
    ...
    IDNReadyWebsites_Logo = models.ImageField(upload_to='core/Idn_websites/', blank=True,
                                                     validators=[validate_image,
                                                                 FileExtensionValidator(
                                                                     allowed_extensions=[
                                                                         "jpg",
...
class SOPTechnologyCategory(models.Model):
    ...
    SOPTechnologyCategory_Thumbnail = models.ImageField(
        upload_to="core/SOPTechnologyCategory/Thumbnail", validators=[validate_image,
                                                         FileExtensionValidator(
                                                             allowed_extensions=["jpg", "png", "JPEG", "svg"])],
        help_text='Maximum file size allowed is 5Mb',
        height_field=None, width_field=None, max_length=None, null=True, blank=True)
...
class SOPTechnologyDocument(models.Model):
    ...
    SOPTechnologyDocument_Thumbnail = models.ImageField(
        upload_to="core/SOPTechnologyDocument/Thumbnail", validators=[validate_image,
                                                         FileExtensionValidator(
                                                             allowed_extensions=["jpg", "png", "JPEG", "svg"])],
        help_text='Maximum file size allowed is 5Mb',
        height_field=None, width_field=None, max_length=None, null=True, blank=True)
    SOPTechnologyDocument_DocumentFile = models.FileField(upload_to="core/SOPTechnologyDocument/DocumentFile",
...
class Blog(models.Model):
    ...
    Blog_Thumbnail = models.ImageField(
        upload_to="core/Blog/Thumbnail", validators=[validate_image,
                                                         FileExtensionValidator(
                                                             allowed_extensions=["jpg", "png", "JPEG", "svg"])],
        
        height_field=None, width_field=None, max_length=None, null=True, blank=True)
    Blog_DocumentFile = models.FileField(upload_to="core/Blog/DocumentFile",
                                             validators=[FileExtensionValidator(['pdf', 'zip', 'csv', 'xls', 'ppt', 'html'])], null=True, blank=True)
